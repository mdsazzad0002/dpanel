...
class WebsiteController extends Controller
{
    ...
    public function installWordPress(Request $request, string $token, string $id): RedirectResponse
    {
    ...
    public function saveFile(Request $request, string $token, string $id): RedirectResponse
    {
        $website = $this->findAuthorizedWebsiteOrFail($id);
