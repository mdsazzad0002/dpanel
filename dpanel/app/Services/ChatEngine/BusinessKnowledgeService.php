...
class BusinessKnowledgeService
{
    ...
    private function formatKnowledge(Business $business): string
    {
        $lines = [
            ...
            'Use ONLY the information below (business profile, products, and Q&A) to answer — never guess, assume, or invent facts, prices, policies, contact details, or availability that are not explicitly stated below. This restriction is about not inventing facts, not about refusing to act: if a search or action tool is available to you (see below), a live lookup or a requested action is not "guessing" — use the tool instead of falling back just because the answer isn\'t written here.',
            ...
            'If the user\'s question is not answered by the information below AND no available tool can resolve it either, respond exactly with: "'.self::FALLBACK_REPLY.'" — do not attempt a best-guess answer. Check your tools first.',
            '',
            '=== BUSINESS KNOWLEDGE ===',
        ];
