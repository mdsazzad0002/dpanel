        ...
        <div
            ...
            :class="toast.type === 'error'
                ...
                : toast.type === 'success'
                    ...
                    : 'rounded-2xl border border-sky-900/40 bg-sky-950/95 px-4 py-3 text-sm text-sky-100 shadow-2xl backdrop-blur'"
        >
