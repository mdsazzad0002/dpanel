            ...
            >
                <div>
                    <textarea
                        ...
                        v-model="sql"
                        rows=""
                        class="h-[stretch] w-full rounded-xl border border-slate-300 bg-slate-50 px-3 py-3 font-mono text-sm text-slate-800 outline-none transition focus:border-cyan-400 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100"
                        spellcheck="false"
                    />
                </div>
                ...
                >
                    ...
                    <div class="max-h-[240px] space-y-1 overflow-auto pr-1">
                        <button
                        ...
                        >
                            ...
                            <span class="shrink-0 text-[10px] uppercase tracking-[0.12em] text-slate-400 dark:text-slate-500">
                                table
                            </span>
                        </button>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full text-left text-sm">
                            <thead class="bg-slate-50 text-xs uppercase tracking-[0.14em] text-slate-500 dark:bg-slate-800">
                                <tr>
                                    <th v-for="column in queryResult.columns" :key="column" class="px-4 py-3">
                                        {{ column }}
                                    </th>
                                </tr>
                            </thead>
