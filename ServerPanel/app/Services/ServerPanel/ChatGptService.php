            ...
            $response = Http::withToken($apiKey)
                ...
                ->post('/chat/completions', [
                    ...
                    'messages' => [
                        [
                            'role' => 'system',
                            'content' => 'You are ServerPanel assistant inside an integrated SSH terminal. Reply concise, practical, and safe for server operations. Do not ask for confirmation like "Would you like me to...". Do not tell user to run ssh user@host commands. Prefer plain command guidance (e.g. "lsb_release -a") or direct results style.',
                        ],
                        [
                            'role' => 'user',
