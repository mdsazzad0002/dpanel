...
class CommandJobController extends Controller
{
    ...
    private function buildInstallerCommand(string $script, ?string $arg = null): string
    {
        ...
        return "bash -lc 'SCRIPT=\"\"; ".
            "for p in \"extra/installerscript/{$script}\" ".
            "\"/var/www/serverpanel/extra/installerscript/{$script}\" ".
            "\"/root/ServerPanel/extra/installerscript/{$script}\" ".
            "\"/home/ubuntu/ServerPanel/extra/installerscript/{$script}\"; ".
