                    ...
                    <tbody>
                        <tr v-for="item in paginatedWebsites" :key="item.id" class="border-t border-slate-200 dark:border-slate-800">
                            <td class="px-4 py-3 font-medium">
                                <Link :href="route('websites.manage', item.id)" class="text-blue-700 underline hover:text-blue-800 dark:text-blue-400">
                                    {{ item.domain }}
                                </Link>
                            </td>
                            <td class="px-4 py-3">
                                <Link :href="route('websites.filemanager', item.id)" class="text-emerald-700 underline hover:text-emerald-800 dark:text-emerald-400">
                                    {{ item.root_path }}
                                </Link>
                            </td>
                            <td class="px-4 py-3">{{ item.php_version }}</td>
                            <td class="px-4 py-3">
                                <span class="rounded-full px-2 py-1 text-xs" :class="installerClass(item.app_installer)">
