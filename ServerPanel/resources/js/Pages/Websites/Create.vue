        ...
        <template #header>
            <div>
                ...
                <p class="text-sm text-slate-500 dark:text-slate-400">
                    Base directory: <strong>{{ normalizedBaseDir }}</strong>. Main domain: <strong>{{ normalizedBaseDir }}/site/public_html</strong>. Subdomain: <strong>{{ normalizedBaseDir }}/site/subdomain</strong>.
                </p>
            </div>
        </template>
