...
const page = usePage();
const isSystemRole = props.systemRoles.includes(props.role.name);
            ...
            <section class="rounded-xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
                <form class="space-y-4" @submit.prevent="submit">
                    <div>
                        ...
                        <TextInput id="name" v-model="form.name" class="mt-1 block w-full" :readonly="isSystemRole" required />
